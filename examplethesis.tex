...
\todoinline{memory allocation was not an issue as both rust and spark use malloc, it was not the case before. you can create your own allocator. some memory regions are not accessible outside of the heap!}
