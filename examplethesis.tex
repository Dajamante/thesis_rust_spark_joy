...
\begin{figure}[!ht]
  ...
  \end{center}
  \caption[Shorter title to be changed later]{Software complexity in the automotive and aerospace industry from\,\cite{moy_when_2020}}
...
\begin{figure}[ht!]
  \centering 
\includesvg[inkscapelatex=false, scale=0.7]{figures/figuressvg/bbqueuelogic.svg}
...
\begin{figure}[ht!]
    ...
    tuborg/.style={decorate, decoration={brace, amplitude=3pt}, line width=1mm},
    tubnode/.style={midway, right=2pt, align=left, font=\large, text width=4cm, xshift=4mm},
    ]         \node[punktchain, join, draw=black,fill=color1bg!50!white] (string){Vec<u8> of UTF-8};  
    % group 2
...
\begin{figure}[ht!]
    ...
    \scalebox{0.8}{
    \begin{tikzpicture}
	\node [draw, rectangle, fill=color1bg!50!white, minimum width=1cm, minimum height=1cm] (box1) at (0,0) {first};
	\node [draw, rectangle, fill=color1bg!50!white, minimum width=1cm, minimum height=1cm, right=0cm of box1] (box2) {last};
