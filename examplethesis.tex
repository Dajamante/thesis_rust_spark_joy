...
\caption{crates.io}
\label{tab:crates_io}
\begin{tabular}{ |m{3cm}|m{3cm}|>{\centering\arraybackslash}m{3cm}|>{\centering\arraybackslash}m{2cm}| }
\hline
...
Numbers 299472 44688 12680
Refs 137439 12662 7140
Arrays 9266 1893 130
Vec 14254 397 977
Enum 14890 602 1162
Struct 48106 4704 2428
String 18540 445 1140
}\EXPDATA 
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \legend{rustc (1518 kLOC), crates.io (171 kLOC), lib.rs (102 kLOC)}
        \end{axis}  
    \end{tikzpicture}
\caption{Rust data types per project}
...
\pgfplotstableread{
Rust_type rustc crates_io lib_rs
Numbers 54.56 68.17 49.17
Refs 25.04 19.32 27.69
Struct 8.76 9.42 7.18
}\PERCENTDATA
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            cycle list name=rustcolors,
            xtick=data,
            symbolic x coords={Numbers,Refs, Struct},
            ybar,
            legend style={at={(0.5,-0.2)},anchor=north},
            ymajorgrids=true,
            grid style=dashed,
...
%Total number of types: 646633
%key : Number, value : 361986, percentage 0.5598
%key : Array, value : 11314, percentage 0.0175
%key : Struct, value : 56087, percentage 0.0867
%key : &T or &mut T, value : 157332, percentage 0.2433
%key : Box/Rc/Arc, value : 7260, percentage 0.0112
%key : String, value : 20198, percentage 0.0312
%key : Vec, value : 15652, percentage 0.0242
%key : Enum, value : 16804, percentage 0.0260
