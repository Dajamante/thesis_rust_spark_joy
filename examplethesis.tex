...
\begin{figure}[ht!]
    ...
    % group 1
         \node[punktchain, join, draw=black,fill=color1bg!50!white] (lit){Litterature study};
         \node[punktchain, join, draw=black,fill=color1bg!50!white] (consult){Consultation with experts};
         \node[punktchain, join, draw=black,fill=color1bg!50!white] (scope){Scope limitation};  
    % group 2
...
\begin{figure}[ht!]
  ...
  \scalebox{0.9}{
    ...
    \foreach \p/\t/\pat\c in {56.06/Numbers/horizontal lines/color1bg!90!white, 24.71/Refs/vertical lines/color2bg!90!white, 11.18/Struct\&Enum/grid/color3bg!90!white, 8.05/others (heap)/crosshatch/color4bg!90!white}
       {
        \global\lena=\lenb
...
\begin{figure}[ht!]
  ...
  \scalebox{0.9}{
    \begin{tikzpicture}[scale=3]
    \centering    
    \foreach \p/\t\pat\c in {58.69/Numbers/horizontal lines/color1bg!90!white, 27.78/Access/vertical lines/color2bg!90!white, 12.65/Record\&Enum/grid/color3bg!90!white, 0.88/others (0.88\%)/crosshatch/color4bg!90!white}   
      {
