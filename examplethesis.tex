...
\todoinline{it is recommended coming from ada to create your own types for pointers as it will go to the common heap}
...
\begin{figure}
    \begin{minipage}{.40\textwidth}
        \begin{bytefield}{24}
        \memsection{..AD0}{..B0F}{4}{Header (64B) - 8 fields of 8 bytes with atomic variables}{color4bg!30}\tikzmark{end}\\
    	\memsection{..B10}{..B9F}{20}{ BBBuffer       \\ UnsafeCell<[u8; 128]> \tikzmark{end2}\\ (128B+16B padding)}{color4bg!30}
    ...
    \begin{minipage}{.40\textwidth}
        ...
        \memsection{..BA0}{..BA7}{2}{\tikzmark{start} 0x..AD0: pointer to header}{color1bg!30}\\
        \memsection{..BA8}{..BAF}{2}{\tikzmark{start2} 0x..B10: pointer to BBBuffer}{color1bg!30}\\
        \memsection{..BB0}{..BB7}{2}{length of read (4)}{color1bg!30}\\
        %\end{rightwordgroup}
    \end{bytefield}
    \end{minipage}
    ...
    \cbox{color4bg!30} Memory assigned in Rust.\quad \\
    \cbox{color1bg!30} Memory passed to SPARK.\quad \\
