...
\begin{figure}[ht!]
    ...
    nodes near coords greater equal only=3,
%----------------------------------------------------------------
        enlargelimits=0.05,
        bar shift=5pt,
        ymin=0,
...
\section[Hardware/Software design \ldots\ /Model/Simulation model \& parameters/\ldots]{Hardware/Software design\ldots\ /Model/Simulation model \& parameters \ldots}
\sweExpl{Hårdvara / Mjukvarudesign \ldots\  / modell / Simuleringsmodell och parametrar / \ldots\ }

Figure~\ref{fig:homepageicon} shows a simple icon for a home page. The time
to access this page when served is quantified in a series of
...
SwapAda
	Description: swapping two integers in a Rust library
Adder	
	Description: Adding to integers in a Swap program

List of assumptions and discussion:
...
\section{Implementation \ldots\ /Modeling/Simulation/\ldots\ }
\label{sec:implementationDetails}
\sweExpl{Implementering \ldots\  / modellering / simulering / \ldots\ }
